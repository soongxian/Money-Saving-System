                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Budget</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.jsp">Home</a></li>
                                <li><a href="index.jsp">Budget</a></li>
                                <li><a href="index.jsp">Edit Budget</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="col-12 mt-5">
                    <div class="card">
                        ...
                        <form action="UpdateBudgetServlet" method="post">
                            <div class="form-group">
                                <input type="hidden" name="category_name" class="form-control" value="<c:out value='${budget.category_name}'/>">
                                <input type="hidden" name="username" class="form-control" value=<%=username%>>
                                <fieldset disabled>
                                    <label>Budget</label>
                                    <input type="text" id="disabledTextInput" name="budget" class="form-control" value="<c:out value='${budget.category_name}'/>">
                                </fieldset> 
                            </div>
                            
                            <label for="name">Limit</label>
                            <div class="input-group mb-3">
                                <input class="form-control form-control-lg" type="text" name="limit_amount" value="<c:out value='${budget.limit_amount}'/>" id="example-text-input-lg">
                            </div>
