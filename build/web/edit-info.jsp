                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Info</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.jsp">Home</a></li>
                                <li><a href="ShowEditUserServlet?username=${username}">Edit Info</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <form action="EditProfileServlet" method="post">
                            <div class="form-group">
                                <input type="hidden" name="username" class="form-control" value="<c:out value='${user.username}'/>">
                                <fieldset disabled>
                                    <label for="username">Username</label>
                                    <input type="text" id="disabledTextInput" name="username" class="form-control" value="<c:out value='${user.username}'/>">
                                </fieldset> 
                            </div>
                            
                            <label for="name">Full Name</label>
                            <div class="input-group mb-3">
                                <input class="form-control form-control-lg" type="text" name="name" value="<c:out value='${user.name}'/>" id="example-text-input-lg">
                            </div>
                            <div class="form-group">
                                <label for="email" class="col-form-label">Email address</label>
                                <input class="form-control form-control-lg" type="text" name="email" value="<c:out value='${user.email}'/>" id="example-text-input-lg">
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-form-label">Password</label>
                                <input class="form-control form-control-lg" type="password" name="password" value="<c:out value='${user.password}'/>" id="example-text-input-lg">
                            </div>

                            <div style="display: flex; align-items: center; justify-content: center;" class="form-group">
                                <input type="submit" onclick="myFunction()" class="btn btn-secondary mb-3" value="Submit">
                            </div>
