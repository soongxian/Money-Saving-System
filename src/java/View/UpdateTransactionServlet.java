...
public class UpdateTransactionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Transaction updateTransaction = new Transaction(transactionid,username,date,source_name,category_name,details,amount);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateTransactionServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
