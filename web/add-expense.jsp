                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="http://localhost:8080/Money_Saving_System/ShowNewExpenseFormServlet?username=${username}">Add Expense</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Add Expense</h4>
                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <c:if test="${transaction!=null}">
                            ...
                            <c:if test="${transaction==null}">
                                <form action="InsertExpenseServlet" method="post">
                                </c:if>
