                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li><a href="http://localhost:8080/Money_Saving_System/ListTransactionServlet?username=" aria-expanded="true"><i class="ti-dashboard"></i><span>Home</span></a></li>
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="http://localhost:8080/Money_Saving_System/ShowNewTransferFormServlet?username=${username}">Add Transfer</a></li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Add Transfer</h4>
            ...
            <div class="main-content-inner">
                <div class="col-12 mt-5">
                    <div class="card">
                        <form action="TransferTransactionServlet" method="post">
                            ...
                            <div class="form-group">
                                <label for="sourceid" class="col-form-label" >From Source</label>
                                <select class="form-control" name="from_source_name">
                            ...
                            <div class="form-group">
                                <label for="sourceid" class="col-form-label">To Source</label>
                                <select class="form-control" name="to_source_name">
                                    <option value="Cash">Cash</option>
                                    <option value="Account">Account</option>
                                    <option value="Card">Card</option>
                                </select>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" placeholder="88.88" aria-label="Amount" name="amount" required>
                            </div>
                            <div class="form-group">
                                <label for="details" class="col-form-label" >Details</label>
                                <input class="form-control form-control-lg" type="text" placeholder="Details" name="details" id="example-text-input-lg">
                            </div>
